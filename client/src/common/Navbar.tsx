  ...
  return (
    <header className="relative bg-black px-3 py-5">
      <nav className="flex justify-evenly items-center">
        ...
        <div>
          <div
            className={`navLinks duration-500 absolute md:static md:w-auto w-full md:h-auto h-[85vh] flex md:items-center gap-[1.5vw] top-[100%] left-[-100%] md:flex-row flex-col px-5 md:py-0 py-5 transition-transform ${
